...
python2.7-dev re2c libnotify-bin daemonize supervisor pv mcrypt bash-completion avahi-daemon apt-transport-https \
imagemagick cifs-utils dos2unix mariadb-client postgresql-client-common
